...
{ 
    ...
    public bool TestBool
    {
        ...
        set { SetProperty(_testString, ref _testBool, value); }
    }
    ...
    public bool CanSaySomething
    {
        ...
        set
        {
            if (SetProperty("CanSaySomething", ref _canSaySomething, value))
                SaySmoething.RaiseCanExecuteChanged();
        }
    }
    ...
    public TestPOCOVm()
    {
        ...
        SaySmoething = new RelayCommand(ImplSaySomething, ImplCanSaySmothing);
    }

    public RelayCommand SaySmoething { get; private set; }
