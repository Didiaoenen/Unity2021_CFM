...
namespace AutoSuggest
{
    ...
    {
        private string _richDisplyText = null;
        ...
        public string RichDisplayText
        {
            get
            {
                if (_richDisplyText == null)
                {
                    _richDisplyText = MakeSubstringBold(DisplayText, DisplayTextMatchIndex, DisplayTextMatchLength);
                }
                return _richDisplyText;
            }
        }
        ...
        public static string MakeSubstringBold(string s, int index, int length)
        {
