...
namespace CFM.Framework.Utilities
{
    public class WeakValueDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IDictionary where TValue : class
    {
        ...
        public ICollection<TKey> Keys { get { return new KeyCollection(dictionary); } }

        public ICollection<TValue> Values { get { return new ValueCollection(dictionary); } }
        ...
        public void AddRange(IDictionary<TKey, TValue> items)
        {
            ...
            if (items.Count > 0)
            {
                if (dictionary.Count > 0 && items.Keys.Any((k) => this.ContainsKey(k)))
        ...
        ICollection IDictionary.Keys { get { return new KeyCollection(dictionary); } }

        ICollection IDictionary.Values { get { return new ValueCollection(dictionary); } }
